...
// Button
const farq = document.getElementById("farq");
...
<span class="Goali">${APISGoals.stats[0].rows[13].stats[0].value}</span>
  ...
  farq.addEventListener("click", () => {
    Goals.classList.add("activetorr");
    Goals.classList.remove("activetor");

    if (EN) {
      EN.classList.remove("activetorr");
    } else {
    }
    if (FR) {
      FR.classList.remove("activetorr");
    } else {
    }
    if (GE) {
      GE.classList.remove("activetorr");
    } else {
    }
    if (MO) {
      MO.classList.remove("activetorr");
    } else {
    }
    if (SP) {
      SP.classList.remove("activetorr");
    } else {
    }
    if (IT) {
      IT.classList.remove("activetorr");
    } else {
    }
    if (EG) {
      EG.classList.remove("activetorr");
    } else {
    }
    if (SU) {
      SU.classList.remove("activetorr");
    } else {
    }
    if (EM) {
      EM.classList.remove("activetorr");
    } else {
    }
    if (IR) {
      IR.classList.remove("activetorr");
    } else {
    }
    if (Al) {
      Al.classList.remove("activetorr");
    } else {
    }
    if (SY) {
      SY.classList.remove("activetorr");
    } else {
    }
    if (JO) {
      JO.classList.remove("activetorr");
    } else {
    }
    if (TU) {
      TU.classList.remove("activetorr");
    } else {
    }
    if (AM) {
      AM.classList.remove("activetorr");
    } else {
    }

    farq.style.background = "#34495e52";
    hadaf.style.background = "";
  });

  hadaf.addEventListener("click", () => {
    Goals.classList.remove("activetorr");
    Goals.classList.add("activetor");

    if (EN) {
      EN.classList.add("activetorr");
    } else {
    }
    if (FR) {
      FR.classList.add("activetorr");
    } else {
    }
    if (GE) {
      GE.classList.add("activetorr");
    } else {
    }
    if (MO) {
      MO.classList.add("activetorr");
    } else {
    }
    if (SP) {
      SP.classList.add("activetorr");
    } else {
    }
    if (IT) {
      IT.classList.add("activetorr");
    } else {
    }
    if (EG) {
      EG.classList.add("activetorr");
    } else {
    }
    if (SU) {
      SU.classList.add("activetorr");
    } else {
    }
    if (EM) {
      EM.classList.add("activetorr");
    } else {
    }
    if (IR) {
      IR.classList.add("activetorr");
    } else {
    }
    if (Al) {
      Al.classList.add("activetorr");
    } else {
    }
    if (SY) {
      SY.classList.add("activetorr");
    } else {
    }
    if (JO) {
      JO.classList.add("activetorr");
    } else {
    }
    if (TU) {
      TU.classList.add("activetorr");
    } else {
    }
    if (AM) {
      AM.classList.add("activetorr");
    } else {
    }

    hadaf.style.background = "#34495e52";
    farq.style.background = "";
  });
